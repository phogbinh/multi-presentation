...
\begin{frame}
  \begin{itemize}
    \item The scheduling problem is an NP-hard problem\proofFootnote.
  \end{itemize}
\end{frame}
...
\begin{frame}
  \begin{itemize}
    \item Our algorithm for the scheduling problem defines the following point:
      \tiny
      \begin{align}
...
\begin{frame}
  \begin{itemize}
    \item The proposed method is a $\frac{\maxCostOneCur}{\minCostOneCur}$-approximation algorithm for the scheduling problem\proofFootnote.
  \end{itemize}
\end{frame}
...
\begin{frame}
  \begin{itemize}
    \item The sorted variant of our algorithm defines the following point:
      \tiny
      \begin{align}
        \urllcLaFourCandidateCur &=
          \begin{cases}
...
\begin{frame}
  \begin{itemize}
    \item The sorted method is an optimal algorithm for the singlecell scheduling problem\proofFootnote.
  \end{itemize}
\end{frame}
